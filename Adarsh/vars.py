...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL','-1001935771201'))
    ...
    DATABASE_URL = str(getenv('DATABASE_URL','mongodb+srv://systemsbackend_db_user:5v0PMU5jhcGOx4cb@streaming.dyhf7wn.mongodb.net/?retryWrites=true&w=majority'))
