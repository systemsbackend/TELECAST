...
class Var(object):
    ...
    DATABASE_URL = str(getenv('DATABASE_URL','mongodb+srv://dmncgitonga:bHnDINb9uLhVTVYF@cluster0.gb3k0qi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'))
