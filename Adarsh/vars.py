...
class Var(object):
    ...
    DATABASE_URL = str(getenv('DATABASE_URL','mongodb+srv://embuonkenya:g4z6IGnxiHOQGUmX@cluster1.sih5q7o.mongodb.net/?retryWrites=true&w=majority&appName=Cluster1'))
